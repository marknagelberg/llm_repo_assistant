...
@pytest.fixture
def temp_python_file_with_function(tmpdir):
...
def test_get_function_docstring_success(temp_python_file_with_function):
    ...
    response = client.get(f"/api/v1/programming/get_function_docstring/python/{file_path}/{function_name}")
...
def test_get_function_docstring_nonexistent_function(temp_python_file_with_function):
    ...
    response = client.get(f"/api/v1/programming/get_function_docstring/python/{file_path}/{nonexistent_function_name}")
...
def test_update_function_docstring_success(temp_python_file_with_function):
    ...
    response = client.put(
        f"/api/v1/programming/update_function_docstring/python/{file_path}/{function_name}",
...
@pytest.fixture
def temp_python_file_with_class(tmpdir):
...
def test_get_module_docstring_success(temp_python_file_with_class):
    ...
    response = client.get("/api/v1/programming/get_module_docstring/python/" + file_path)
...
def test_get_module_docstring_no_docstring(temp_python_file_without_docstring):
    ...
    # Call the get_module_docstring endpoint
    response = client.get(f"/api/v1/programming/get_module_docstring/python/{file_path}")
...
def test_update_module_docstring_success(temp_python_file_with_class):
    ...
    response = client.put(
        f"/api/v1/programming/update_module_docstring/python/{file_path}",
        json={"new_docstring": new_docstring}
    )
